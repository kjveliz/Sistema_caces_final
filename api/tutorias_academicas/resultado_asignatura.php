...
// Se recalcula en cada consulta (no se cachea): la validación puede haber
// cambiado desde la última carga, y esto es lo que confirmaste como
// comportamiento esperado ("recalcula también al ver resultados").
$resultado = calcularResultadoAsignaturaTutorias($conexion, $idAsignatura, $asignatura['nombre']);
guardarSnapshotTutorias($conexion, $idAsignatura, $idEvaluacion, $resultado);
