...
final class CatalogoEvidenciasSeeder extends AbstractSeed
{
    ...
    public function run(): void
    {
        $this->table('catalogo_evidencias')->insert([
            ...
            ['id_catalogo' => 16, 'id_indicador' => 3, 'codigo_evidencia' => 'DOC.TUT.04', 'titulo_corto' => 'Reglamento institucional', 'descripcion' => 'Normativa institucional de tutorías (EF4 — Normativas institucionales)', 'nombre_archivo_base' => 'Evidencias_Atencion', 'orden' => 4, 'activo' => 1],
            ...
            ['id_catalogo' => 20, 'id_indicador' => 2, 'codigo_evidencia' => 'DOC.SEG.06', 'titulo_corto' => 'Reporte de Control de Seguimiento de Contenidos por Materia Ingresados en el SIU', 'descripcion' => 'Reporte del SIU con % de avance de contenidos dictados por asignatura (EF1)', 'nombre_archivo_base' => 'Reporte_Control_Seguimiento', 'orden' => 8, 'activo' => 1],
            ['id_catalogo' => 21, 'id_indicador' => 2, 'codigo_evidencia' => 'DOC.SEG.07', 'titulo_corto' => 'Reporte de Contenidos y Avances Dictados del Syllabus', 'descripcion' => 'Reporte del SIU con detalle unidad por unidad de contenidos dictados (EF1)', 'nombre_archivo_base' => 'Reporte_Avances_Syllabus', 'orden' => 9, 'activo' => 1],
        ])->saveData();
    }
}
