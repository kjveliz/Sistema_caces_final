...
export const MATERIAS_BY_PAO_MODULE: Record<string, Record<string, string[]>> = {
  'PAO 1': {
    A: [
  ...
  'PAO 2': {
    ...
    B: ['Fundamentos de Bases de Datos', 'Humanismo y Sociedad'],
  ...
  'PAO 3': {
    ...
    C: ['Integración Curricular en Programación Aplicada', 'Investigación Aplicada y Titulación'],
  },
};
