...
export const ASIGNATURAS_BY_PAO: Record<string, I2Materia[]> = {
  'PAO 1': [
    ...
    {
      name: 'Desarrollo de Interfaces de Usuario y Experiencia de Usuario (UI/UX)',
      ef: [0.75, 0.85, 0.88, 0.7, 0.95],
    },
    {
      name: 'Bases para el desarrollo de Aplicaciones Móviles para Android',
  ...
  'PAO 2': [
    ...
    {
      name: 'Implementación de Estructuras de Datos y Algoritmos Avanzados',
  ...
  'PAO 3': [
    ...
    {
      name: 'Principios de los Sistemas Operativos e Implementación de Software Empresarial',
      ef: [0, 0, 0, 0, 0],
    },
    {
