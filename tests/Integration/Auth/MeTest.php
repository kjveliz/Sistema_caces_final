...
/**
 * Tests de integración de api/auth/Me.php -- el endpoint "whoami" que le
 * permite al frontend recuperar la sesión tras un refresh de página (Fase 4
 * del Plan de Mejora, persistencia de sesión, pendiente desde v73).
 */
final class MeTest extends IntegrationTestCase
{
    public function testMeSinSesionActivaDevuelve401(): void
    {
        $respuesta = $this->peticion('GET', '/api/auth/Me.php');
    ...
    {
        $respuesta = $this->peticion('POST', '/api/auth/Me.php');
